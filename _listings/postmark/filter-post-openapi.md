  ...
  /filter:
    post:
      ...
      description: "Postmark\u2019s spam API is a RESTfull interface to the Spam filter
        ...
        The POST body must have an element \"email\" which is the raw dump of the
        email to be filtered, including all headers. And an element \"options\" which
        must either be \"long\" for a full report of processing rules, or \"short\"
        for a score request."
